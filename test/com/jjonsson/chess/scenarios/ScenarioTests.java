...
public class ScenarioTests
{
	...
	{
		File scenarioFile = new File("test/scenarios/new_move_is also_on_stopping_path_take_over_should_also_be_possible.chess");
		ChessBoard board = new ChessBoard();
		if(!BoardLoader.loadFileIntoBoard(scenarioFile, board))
		{
			Assert.fail("Could not load:" + scenarioFile.toString());
		}
	...
	{
		File scenarioFile = new File("test/scenarios/should_be_stalemate.chess");
		ChessBoard board = new ChessBoard();
		if(!BoardLoader.loadFileIntoBoard(scenarioFile, board))
		{
			Assert.fail("Could not load:" + scenarioFile.toString());
	...
	{
		File scenarioFile = new File("test/scenarios/next_pawn_time_for_replacement_move_should_check_king_horse_take_queen_then_no_more_check.chess");
		ChessBoard board = new ChessBoard();
		if(!BoardLoader.loadFileIntoBoard(scenarioFile, board))
		{
			Assert.fail("Could not load:" + scenarioFile.toString());
	...
	{
		File scenarioFile = new File("test/scenarios/should_not_be_check.chess");
		ChessBoard board = new ChessBoard();
		if(!BoardLoader.loadFileIntoBoard(scenarioFile, board))
		{
			Assert.fail("Could not load:" + scenarioFile.toString());
	...
	{
		File scenarioFile = new File("test/scenarios/queen_left_move_check_king_not_possible_to_move_down.chess");
		ChessBoard board = new ChessBoard();
		if(!BoardLoader.loadFileIntoBoard(scenarioFile, board))
		{
			Assert.fail("Could not load:" + scenarioFile.toString());
	...
	{
		File scenarioFile = new File("test/scenarios/knight_should_not_be_possible_to_take.chess");
		ChessBoard board = new ChessBoard();
		if(!BoardLoader.loadFileIntoBoard(scenarioFile, board))
		{
			Assert.fail("Could not load:" + scenarioFile.toString());
